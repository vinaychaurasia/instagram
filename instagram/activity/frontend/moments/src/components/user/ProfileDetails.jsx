...
class ProfileDetails extends Component {
    ...
    // 3.
    componentDidMount(){
        axios.get("/api/v1/users/77c3d317-ece3-40e9-bbc8-4262e84f3b6c").then((res) => {
            ...
            let followerP = axios.get("/api/v1/users/followreq/77c3d317-ece3-40e9-bbc8-4262e84f3b6c")
            return followerP;
