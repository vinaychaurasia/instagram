...
let{createUser, getUser, updateUser, deleteUser, handleRequest, acceptRequest, rejectRequest, getAllFollowers} = 
        require("../controller/userController");

//user router
userRouter.post("/", createUser);
userRouter.route("/followreq").post(handleRequest);
userRouter.route("/followreq/:user_id").get(getAllFollowers);
